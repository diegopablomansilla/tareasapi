...
import com.ms.back.dao.OrdenFabricacionFindAllDAO;
import com.ms.back.model.NoPagin;

public class OrdenFabricacionFindAll extends AbstractService {

	private OrdenFabricacionFindAllDAO dao = new OrdenFabricacionFindAllDAO();

	public OrdenFabricacionFindAll(EnvironmentVariables vars) {
		super(vars);
	}
