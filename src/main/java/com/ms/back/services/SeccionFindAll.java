...
import com.ms.back.dao.SeccionFindAllDAO;
import com.ms.back.model.NoPagin;

public class SeccionFindAll extends AbstractService {

	private SeccionFindAllDAO dao = new SeccionFindAllDAO();

	public SeccionFindAll(EnvironmentVariables vars) {
		super(vars);
