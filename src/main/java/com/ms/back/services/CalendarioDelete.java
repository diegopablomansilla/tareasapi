...
import com.ms.back.dao.CalendarioDeleteDAO;

public class CalendarioDelete extends AbstractService {

	private CalendarioDeleteDAO dao = new CalendarioDeleteDAO();

	public CalendarioDelete(EnvironmentVariables vars) {
		super(vars);
...
//		String pass = request.getParameter("pass");
		...
		JsonObject item = dao.exec(vars.getDataBases().get(0), id);
